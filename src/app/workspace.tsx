...
export default function Workspace() {
  ...
  return <div className="app-shell">
    ...
    <header className="site-header">
      ...
      <div className="header-meta"><span className={`connection-badge ${webMcp}`}><span aria-hidden="true" />{webMcp === "connected" ? "WebMCP connected" : webMcp === "checking" ? "Checking WebMCP" : "WebMCP preview"}</span><button className="avatar" type="button" aria-label="Reviewer profile">TG</button></div>
    </header>
    <main id="top">
    ...
    <footer><p>Protocol Mirror is a research transparency aid—not medical advice or a finding of misconduct.</p><p>{accepted.length} accepted · {audit.history.length} auditable events · deterministic demo data</p></footer>
  </div>;
}
